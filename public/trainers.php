        ...
        <form method="POST" class="space-y-4">
            ...
            <div class="flex gap-4">
                ...
                <div class="flex-1">
                    ...
                    <input name="specialty" class="w-full px-3 py-2 bg-gray-700 rounded-lg text-gray-200">
                </div>
            </div>
            <div>
            ...
            <div class="flex gap-4">
             ...
             <div>
                ...
                <input name="experience_years" type="number" class="w-full px-3 py-2 bg-gray-700 rounded-lg text-gray-200">
            </div>
